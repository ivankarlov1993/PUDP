...
?>
    ...
    <br><?$APPLICATION->IncludeComponent("bitrix:news", "offers", Array(
	"IBLOCK_TYPE" => "6",	// Тип инфоблока
	...
	"SEF_FOLDER" => "/offers/",	// Каталог ЧПУ (относительно корня сайта)
	...
	"SEF_URL_TEMPLATES" => array(
		"news" => "/offers/index.php",
		"section" => "/offers/index.php",
		"detail" => "#ELEMENT_CODE#/",
	)
	),
	false
